class Urls {
  ...
  static const String getDistrictData = '$_baseUrl/district/2';
  static const String getUpzilaData = '$_baseUrl/upzila/8';
  static const String getUnionData = '$_baseUrl/union/79';
