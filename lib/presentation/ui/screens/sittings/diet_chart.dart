            ...
            children: <Widget>[
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('2. Lentils',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/red lentils.png',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('3. Spinach',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/spinach.png',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('4. Lean Red Meat',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/lean red meat.jpg',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('5. Watermelon',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/watermelon.jfif',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('3. Cookies',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/cookies.png',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('5. Mocktails',
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/mocktails.png',
                  width: MediaQuery.of(context).size.width - 32,
                  height: 210,
                  fit: BoxFit.cover),
              const SizedBox(height: 10),
