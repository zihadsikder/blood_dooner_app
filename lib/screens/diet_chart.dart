  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Diet Chart', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white)),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 15),
              const Text('2. Lean Red Meat', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/meat.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('3. Lentils', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/lentils.png', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('4. Spinach', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/spinach-leaves.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 10),
              Image.asset('assets/juice.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('2. Cookies', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/cookies.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('3. Avocado', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/avocados.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('4. Mocktails', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/mocktails.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 15),
              const Text('5. Cereal', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/cereal.jpg', width: MediaQuery.of(context).size.width-32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
