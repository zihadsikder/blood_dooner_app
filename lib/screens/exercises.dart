  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Exercises', style: TextStyle(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 15),
              const Text('1. Squat-To-Row With Resistance Band', style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
                  color: Colors.black)),
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('2. Push-Ups', style: TextStyle(
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('3. Ankle Pumps', style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
                  color: Colors.black)),
              const SizedBox(height: 10),
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('4. Diaphragmatic Breathing', style: TextStyle(fontWeight: FontWeight.bold,
                  fontSize: 14,
                  color: Colors.black)),
              const SizedBox(height: 10),
              ...
              const Text(
                  ...
                  style: TextStyle(
                      letterSpacing: 0.4, fontSize: 13, color: Colors.black)),
              const SizedBox(height: 15),
              const Text('5. Punch-And-Twist', style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 14,
                  color: Colors.black)),
              const SizedBox(height: 10),
              Image.asset('assets/ex-5.jpg', width: MediaQuery
                  .of(context)
                  .size
                  .width - 32, height: 210, fit: BoxFit.cover),
              const SizedBox(height: 10),
